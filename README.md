...
* [SOCTalk](https://github.com/soctalk/soctalk) - Open source, LLM driven SOC automation platform for MSPs and MSSPs built on Wazuh. Continuously triages, investigates, and escalates alerts through a two tier AI pipeline with human in the loop review, multi tenant Kubernetes isolation per customer, built in case management, and optional TheHive and Cortex integration. Apache 2.0.
